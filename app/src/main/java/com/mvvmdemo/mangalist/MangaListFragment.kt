...
class MangaListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_mangalist_list, container, false)
        ...
        if (view is RecyclerView) {
            ...
            view.adapter = MyMangaListRecyclerViewAdapter(DummyContent.ITEMS, mListener)
        }
        return view
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): MangaListFragment {
